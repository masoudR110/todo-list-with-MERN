...
const Task = () => {
    return (
        <div className="task-box">
            <svg className="task-box__checkbox-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <p className="task-box__title">Hello Masoud</p>
            <svg className="task-box__trash-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
